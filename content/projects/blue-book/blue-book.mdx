...
![Initial "mode vs topic" exploration](./sketch0-crop.png)
<span class="img-cap">Initial "mode vs topic" exploration</span>

After finalizing this route of information architecture, I sketched out possible screens and flow, eventually incorporating those designs into interactive Adobe XD wireframes.

![First sketches](./sketch23-resize.png)
