...
<div class="list-links">
    <ul> 
        <li><a href="https://xd.adobe.com/view/db3abce2-84c6-412d-4720-a4b1cd5ea877-ad0b/?fullscreen" target="_blank">View live site &#8594;</a></li>
        <li><a href="https://drive.google.com/drive/folders/1nHDb3JS-WmEemLKwcX6amH9iB3iR0UD0?usp=sharing" target="_blank">View recorded interactions &#8594;</a></li>
        <li><a href="https://drive.google.com/file/d/17ub46XpTHxMMg5AheslINrH9HeoMQl7R/view?usp=sharing" target="_blank">Read extended documentation &#8594;</a></li>
    </ul>
</div>
...
![Initial sketches](./capstone-sketches.jpg)
<span class="img-cap">Initial sketches of how I envisioned the project to look</span>
...
As I started designing the recipe book pages, I also illustrated different dishes that would accompany the recipes, the background textures for the pages themselves, and handwritten notes and titles.

![Handwritten title tests](./titles2.png)
<span class="img-cap">A few handwriting tests for the recipe titles</span>

![Background test placement](./bgbg.png)
<span class="img-cap">One of the placements I was testing for background objects</span>
...
![Cookbook open to lechon page](./LECHON.png)
<span class="img-cap">One of the open pages of the cookbook</span>
...
Thanks to the feedback of my peers, I also ended up including more illustrations than originally planned.
